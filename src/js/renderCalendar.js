...
function calendarApiService(date) {
  let selectedDate = addZero(date.getFullYear()) + addZero(date.getMonth() + 1) + addZero(date.getDate());
  ...
  apiService.getDateAndCategoryNews(selectedDate, selectedCategories)
    .then(articles => {
